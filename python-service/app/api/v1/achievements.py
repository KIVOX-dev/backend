...
def evaluate_achievements(
    ...
    test_count = db["assessment_attempts"].count_documents(
...
def leaderboard(
    scope: str = "national", db=Depends(get_db), current_user=Depends(get_current_user)
):
