...
INDEX_SPECS: list[tuple[str, list[tuple[str, int]], dict]] = [
    ...
    (
        "users",
        [("college_id", ASCENDING), ("role", ASCENDING), ("created_at", DESCENDING)],
        {"name": "ix_users_college_role_created"},
    ),
    (
        "users",
        [("status", ASCENDING), ("college_id", ASCENDING), ("created_at", DESCENDING)],
    ...
    (
        "assessments",
        [("college_id", ASCENDING), ("created_at", DESCENDING)],
    ...
    (
        "messages",
        [("sender_id", ASCENDING), ("receiver_id", ASCENDING), ("timestamp", ASCENDING)],
        {"name": "ix_msg_pair_time"},
    ),
    (
        "messages",
        [("receiver_id", ASCENDING), ("timestamp", DESCENDING)],
