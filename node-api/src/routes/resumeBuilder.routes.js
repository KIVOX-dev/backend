...
router.post('/analyze', authorize(ROLES.STUDENT), aiLimiter, aiInstitutionLimiter, controller.analyze);
router.post(
  '/match-jd',
  authorize(ROLES.STUDENT),
  aiLimiter,
  aiInstitutionLimiter,
  validate(schema.matchJd),
...
router.post('/parse', aiLimiter, aiInstitutionLimiter, validate(schema.parse), controller.parseResumeText);
